...
module.exports.ConsensusService =
  require("./precompiled/consensus").ConsensusService;
module.exports.SystemConfigService =
  require("./precompiled/systemConfig").SystemConfigService;
module.exports.PermissionService =
  require("./precompiled/permission").PermissionService;
...
module.exports.EVENT_LOG_FILTER_PUSH_STATUS =
  require("./event").EVENT_LOG_FILTER_PUSH_STATUS;
...
module.exports.Decoder = require("./decoder").Decoder;
